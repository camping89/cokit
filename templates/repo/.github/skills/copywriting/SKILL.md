...
```bash
python $HOME/.copilot/skills/copywriting/scripts/extract-writing-styles.py --list        # List files
python $HOME/.copilot/skills/copywriting/scripts/extract-writing-styles.py --style <name> # Extract style
```
