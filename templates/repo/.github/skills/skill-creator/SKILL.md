...
- **Referenced scripts**:
  ...
  - Make sure scripts respect `.env` file follow this order: `process.env` > `$HOME/.copilot/skills/${SKILL}/.env` > `$HOME/.copilot/skills/.env` > `$HOME/.copilot/.env` 
...
- Make sure scripts respect `.env` file follow this order: `process.env` > `$HOME/.copilot/skills/docs-seeker/.env` > `$HOME/.copilot/skills/.env` > `$HOME/.copilot/.env`
...
- [Agent Skills Spec]($HOME/.copilot/skills/agent_skills_spec.md)
