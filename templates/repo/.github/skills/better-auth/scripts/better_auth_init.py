...
.env loading order: process.env > skill/.env > skills/.env > .copilot/.env
"""
...
class BetterAuthInit:
    ...
    def _load_env_files(self) -> Dict[str, str]:
        ...
        Loading order: process.env > skill/.env > skills/.env > .copilot/.env
        ...
        env_paths = [
            self.project_root / ".copilot" / ".env",
            self.project_root / ".copilot" / "skills" / ".env",
            skill_dir / ".env",
        ]
