...
### Research
* Use 2 `ck-researcher` subagents in parallel to search up to 5 sources
* Keep every research report concise (≤150 lines)
* Use `/ck-scout` skill invocation to search the codebase

### Code Review
* Use multiple `ck-code-reviewer` subagents in parallel to review code
...
### Plan
* Use `ck-planner` subagent to analyze reports and create improvement plan
