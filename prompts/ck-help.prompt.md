...
```bash
python $HOME/.copilot/scripts/ck-help.py "${input}"
```
...
- Use global (~/.copilot/.ck.json) for personal preferences like language, issue prefix style
- Use local ($HOME/.copilot/.ck.json) for project-specific paths, naming conventions
