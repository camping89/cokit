...
def find_api_key():
    ...
    try:
        ...
        if api_key:
            ...
            print_info("python ~/.copilot/scripts/resolve_env.py GEMINI_API_KEY --skill ai-multimodal --verbose")
...
def provide_setup_instructions():
    ...
    print(f"   $ echo 'GEMINI_API_KEY=your-api-key-here' >> ~/.copilot/.env")
    ...
    print("\n4. Debug if needed:")
    print(f"   $ python ~/.copilot/scripts/resolve_env.py --show-hierarchy --skill ai-multimodal")
    print(f"   $ python ~/.copilot/scripts/resolve_env.py GEMINI_API_KEY --skill ai-multimodal --verbose")
