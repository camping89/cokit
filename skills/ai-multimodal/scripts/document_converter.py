...
def find_api_key() -> Optional[str]:
    ...
    2. .copilot/skills/ai-multimodal/.env (skill-specific config)
    3. .copilot/skills/.env (shared skills config)
    4. .copilot/.env (Claude global config)
    """
    ...
    if load_dotenv:
        ...
        skill_dir = script_dir.parent  # .copilot/skills/ai-multimodal
        skills_dir = skill_dir.parent   # .copilot/skills
        claude_dir = skills_dir.parent  # .copilot
...
def find_project_root() -> Path:
    ...
    # Look for .git or .copilot directory
