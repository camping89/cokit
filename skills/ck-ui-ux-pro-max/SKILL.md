...
```bash
python3  "<keyword>" --domain <domain> [-n <max_results>]
```
...
```bash
python3  "<keyword>" --stack html-tailwind
```
...
python3  "beauty spa wellness service" --domain product

# 2. Search style (based on industry: beauty, elegant)
python3  "elegant minimal soft" --domain style

# 3. Search typography
python3  "elegant luxury" --domain typography

# 4. Search color palette
python3  "beauty spa wellness" --domain color

# 5. Search landing page structure
python3  "hero-centric social-proof" --domain landing

# 6. Search UX guidelines
python3  "animation" --domain ux
python3  "accessibility" --domain ux

# 7. Search stack guidelines (default: html-tailwind)
python3  "layout responsive" --stack html-tailwind
```
