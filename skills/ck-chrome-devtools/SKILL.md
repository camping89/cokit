...
node aria-snapshot.js --url https://example.com --output 
```
...
Skills can exist in **project-scope** or **user-scope**. Priority: project-scope > user-scope.
Store snapshots for analysis in `<project>/:
...
Skills can exist in **project-scope** or **user-scope**. Priority: project-scope > user-scope.
For complex automation, write scripts to `<project>/:
...
Skills can exist in **project-scope** or **user-scope**. Priority: project-scope > user-scope.
Store screenshots for analysis in `<project>/:

```bash
# Basic screenshot
node screenshot.js --url https://example.com --output 

# Full page
node screenshot.js --url https://example.com --output  --full-page true

# Specific element
node screenshot.js --url https://example.com --selector ".main-content" --output 
```
...
node screenshot.js --url https://example.com --output  --max-size 3

# Disable compression
node screenshot.js --url https://example.com --output  --no-compress
```
...
Store logs for analysis in `<project>/:
