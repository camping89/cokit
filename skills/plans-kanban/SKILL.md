...
cd $HOME/.copilot/skills/plans-kanban
npm install
```
...
node $HOME/.copilot/skills/plans-kanban/scripts/server.cjs \
  --dir ./plans \
  --open
...
node $HOME/.copilot/skills/plans-kanban/scripts/server.cjs --stop
```
