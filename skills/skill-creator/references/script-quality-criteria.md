...
2. `$HOME/.copilot/skills/<skill-name>/.env` (skill-specific)
3. `$HOME/.copilot/skills/.env` (shared skills)
...
load_dotenv('$HOME/.copilot/.env')
load_dotenv('$HOME/.copilot/skills/.env')
load_dotenv('$HOME/.copilot/skills/my-skill/.env')
